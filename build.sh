...
${nuget_cmd} install src/EcoServerAPI/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/EcoServerAPI.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/EcoServerAPI.dll \
-recurse:'src/EcoServerAPI/*.cs' \
-doc:bin/EcoServerAPI.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/EcoServerAPI.dll was created successfully"
fi
