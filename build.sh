...
${nuget_cmd} install src/EcoServer-API/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/EcoServer-API.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/EcoServer-API.dll \
-recurse:'src/EcoServer-API/*.cs' \
-doc:bin/EcoServer-API.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/EcoServer-API.dll was created successfully"
fi
