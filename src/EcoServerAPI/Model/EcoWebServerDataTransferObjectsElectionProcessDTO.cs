...
{
    /// <summary>
    /// EcoWebServerDataTransferObjectsElectionProcessDTO
    /// </summary>
    [DataContract]
    public partial class EcoWebServerDataTransferObjectsElectionProcessDTO :  IEquatable<EcoWebServerDataTransferObjectsElectionProcessDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EcoWebServerDataTransferObjectsElectionProcessDTO" /> class.
        /// </summary>
        /// <param name="occupantNames">occupantNames.</param>
        public EcoWebServerDataTransferObjectsElectionProcessDTO(List<string> occupantNames = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EcoWebServerDataTransferObjectsElectionProcessDTO {\n");
        ...
        {
            return this.Equals(input as EcoWebServerDataTransferObjectsElectionProcessDTO);
        }

        /// <summary>
        /// Returns true if EcoWebServerDataTransferObjectsElectionProcessDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of EcoWebServerDataTransferObjectsElectionProcessDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EcoWebServerDataTransferObjectsElectionProcessDTO input)
        {
            if (input == null)
                return false;
